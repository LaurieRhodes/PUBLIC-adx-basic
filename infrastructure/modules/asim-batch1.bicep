...
resource cluster 'Microsoft.Kusto/clusters@2022-02-01' existing = {
  ...
  resource kustoDb 'databases' existing = {
    ...
    resource ASIM1Script 'scripts' = {
      name: 'ASIM1Script'
      properties: {
        scriptContent: loadTextContent('../ASIM1.kql')
    ...
    resource ASIM2Script 'scripts' = {
      name: 'ASIM2Script'
      properties: {
        scriptContent: loadTextContent('../ASIM2.kql')
        continueOnErrors: false
      }
    }
    ...
    resource ASIM3Script 'scripts' = {
      name: 'ASIM3Script'
      properties: {
        scriptContent: loadTextContent('../ASIM3.kql')
        continueOnErrors: false
      }
    }
    ...
    resource ASIM4Script 'scripts' = {
      name: 'ASIM4Script'
      properties: {
        scriptContent: loadTextContent('../ASIM4.kql')
        continueOnErrors: false
      }
    }
    ...
    resource ASIM5Script 'scripts' = {
      name: 'ASIM5Script'
      properties: {
        scriptContent: loadTextContent('../ASIM5.kql')
        continueOnErrors: false
      }
    }
  }
